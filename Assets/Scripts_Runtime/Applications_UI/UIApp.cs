...
namespace Alter {
    public static class UIApp {
        ...
        public static void GameInfo_RefreshStep(UIAppContext ctx, int step) {
            PanelGameInfoDomain.RefreshStep(ctx, step);
        }

        public static void GameInfo_RefreshScore(UIAppContext ctx, int score) {
            PanelGameInfoDomain.RefreshScore(ctx, score);
        }

        public static void GameInfo_RefreshNextScore(UIAppContext ctx, int score, Color color) {
            PanelGameInfoDomain.RefreshNextScore(ctx, score, color);
        }
